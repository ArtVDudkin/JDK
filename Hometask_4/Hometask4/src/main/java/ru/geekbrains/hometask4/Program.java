...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        Employee worker4 = new Employee("Grigory","45678", LocalDate.of(2013,3,13));
        Employee worker5 = new Employee("Denis","56789", LocalDate.of(2014,4,14));
        Employee worker6 = new Employee("Evgeny","123456", LocalDate.of(2015,5,15));
        ...
        System.out.println(employees.getEmployeeByNo(1003));
